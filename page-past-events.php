...
<main class="wrapper">
    ...
    <section class="about-us my-4 px-3">
        <div class="about-us row justify-content-around ">
            <div class="col-12 mx-3 d-md-flex justify-content-center ">
                <div class="about-conatiner col-10 col-md-8 col-lg-7 text-justify pl-4 ">
                    ...
                    while ($pastEvents->have_posts()) {
                        ...
                        <a href="<?php the_permalink() ?> ">
                            <article id="<?php echo get_the_ID(); ?>" class="event  my-md-6 p-4">
                                <h2><?php the_title(); ?></h2>
                ...
                <div class="sidebar col-10 col-md-3 mx-3">
                    sidebar
                </div>
            </div>
