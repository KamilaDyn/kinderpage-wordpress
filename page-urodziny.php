...
<main class="wrapper">
    <section>
        <header class="bookmark container-fluid">
            ...
            <h1 class="text-center">Urodziny w przedszkolu</h1>
            ...
            <div class="about-us row justify-content-around ">
                <div class="birthday about-conatiner col-10 col-md-7 col-lg-8 text-justify " style="background-image: url(<?php echo get_theme_file_uri('./images/party.webp'); ?>)">
                    ...
                    <p>Każde dziecko z wielką niecierpliwością wyczekuje swoich urodzin i marzy o tym, aby był to dzień wyjątkowy.
                        Wiemy jak wiele radości sprawia im to kiedy mogą się bawić w gronie swoich koleżanek i kolegów z przedszkola.
                    </p><br>
                    <h5>Nasza oferta:</h5>
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-arrow-circle-right text-info"></i> Nauczyciel przygotowuje na tę okazję: <br>
                            ...
                            – Poczęstunek, zaproszenia oraz upominki dla solenizanta organizują Państwo we własnym zakresie.
                        </li>
                    </ul>
                    <h5>Cennik:</h5>
                    <p>1 wariant– urodzinową zastawę stołową (obrus, kubeczki, talerzyki, serwetki) organizuje nauczyciel- 230 zł
                    </p>
                    <p>2 wariant– zastawę stołową organizują Państwo we własnym zakresie (zakup i samodzielne dekorowanie stołu)
                        –150 zł
                        Opłata przyjmowana jest w sekretariacie przedszkola.
                    </p>
